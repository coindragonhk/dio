...
mixin _$NetworkExceptions {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String errorCode, String message, dynamic data)
        defaultError,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String errorCode, String message, dynamic data)?
        defaultError,
...
abstract class _$$DefaultErrorImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({String errorCode, String message, dynamic data});
}
...
class _$DefaultErrorImpl implements DefaultError {
  const _$DefaultErrorImpl(this.errorCode, this.message, this.data);
  ...
  @override
  String toString() {
    return 'NetworkExceptions.defaultError(errorCode: $errorCode, message: $message, data: $data)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return defaultError(errorCode, message, data);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return defaultError?.call(errorCode, message, data);
  }
...
abstract class DefaultError implements NetworkExceptions {
  const factory DefaultError(
          final String errorCode, final String message, final dynamic data) =
      _$DefaultErrorImpl;
