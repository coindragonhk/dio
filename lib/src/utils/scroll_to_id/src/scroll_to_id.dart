...
class ScrollToId {
  ...
  Future<void> animateTo(String id,
      {required Duration duration, required Curve curve, double extraOffset = 0}) async {
    Function _function = (double offset) {
      scrollController!.animateTo(offset + extraOffset, duration: duration, curve: curve);
    };
  ...
  Future<void> jumpTo(String id, {double extraOffset = 0} ) async {
    Function _function = (double offset) {
