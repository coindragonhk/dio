...
class MultiPageText extends StatefulWidget {
  ...
  @override
  State<MultiPageText> createState() => MultiPageTextState();
}

class MultiPageTextState extends State<MultiPageText> {
  ...
  List<String> _getPageTexts() {
    ...
    // pages.forEachIndexed((index, element) {
  ...
  void updatePageIndex(PageUpdateOperation pageUpdateOperation) {
    switch (pageUpdateOperation) {
      case PageUpdateOperation.first:
        setState(() {
          _currentPageIndex = 0;
          controller.animateToPage(_currentPageIndex,
  ...
  Widget build(BuildContext context) {
    return PageView.builder(
      ...
      itemCount: widget.textPages.length,
      controller: controller,
      physics: const NeverScrollableScrollPhysics(),
      itemBuilder: (BuildContext context, int itemIndex) {
        return PageTextContainer(
          text: widget.textPages[_currentPageIndex],
          textStyle: widget.textStyle,
          padding: widget.paddingTextBox,
          size: _availableSize,
