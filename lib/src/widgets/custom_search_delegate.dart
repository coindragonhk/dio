...
///
/// A given [CustomSearchDelegate] can only be associated with one active [showSearch]
...
/// ## Handling emojis and other complex characters
/// {@macro flutter.widgets.EditableText.onChanged}
abstract class CustomSearchDelegate<T> extends SearchDelegate<T> {
  ...
  /// {@tool snippet}
  /// ```dart
  /// class CustomSearchHintDelegate extends CustomSearchDelegate<String> {
  ...
  set query(String value) {
    ...
    if (_queryTextController.text.isNotEmpty) {
      _queryTextController.selection =
          TextSelection.fromPosition(TextPosition(offset: _queryTextController.text.length));
    }
  }
          ...
          appBar: AppBar(
            ...
            title: TextField(
              ...
              decoration: InputDecoration(
                  ...
                  prefixIcon: Padding(
                    padding: EdgeInsets.only(top: 12.h, bottom: 12.h, left: 10.w, right: 5.w),
                    child: Image.asset(
                  ...
                  suffixIcon: Padding(
                    padding: EdgeInsets.only(top: 12.h, bottom: 12.h, left: 5.w, right: 12.w),
                    child: Utils.isEmpty(widget.delegate._queryTextController.text)
                        ? SizedBox(
                            width: 20.w,
                            height: 20.h,
                          )
