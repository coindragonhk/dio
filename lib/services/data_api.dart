...
class Api {
  ...
  static Future<VideosList?> getVideos() async {
    List data = [];
  ...
  static Future<VideosList?> getVideolimited() async {
    Random random = Random();
    int randomNumber = random.nextInt(50);
    final response = await http.get(
      Uri.parse(
  ...
  static Future<VideosList?> getSearchedVideo(String searchtext) async {
    List data = [];
